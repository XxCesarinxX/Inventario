...
def vent():
    ...
    df_Concatena = pd.DataFrame(dic_Venta)#el diccionario lo hace df
    save = pd.concat([sell,df_Concatena])#junta el df de almacen con el creado
    save.set_index("Modelo") #indexa el df con la columna del parametro
    print(df_Concatena, "\ndf ventas\n", save)
